...
/**Realiza un buffer a cada elemento segun
 *  el valor del campo pasado por parametros*/
public class BufferByFieldAlgorithm extends GeoAlgorithm {
   ...
   public boolean processAlgorithm() throws GeoAlgorithmExecutionException {
      ...
      while (iter.hasNext() && setProgress(i, iTotal)) {
         ...
         double dist = Double.parseDouble(feature.getRecord().getValue(fieldIndex).toString());
         computeBuffer(feature.getGeometry(), dist, feature.getRecord().getValues());
         i++;
      }
      iter.close();
   ...
   public void defineCharacteristics() {
      ...
      try {
         ...
         m_Parameters.addString(FIELD, Sextante.getText("Field that contain de buffer value"), "gid");
   ...
   public void computeBuffer(final Geometry originalGeometry,
      ...
      if (!m_bRounded) {
         cap = BufferOp.CAP_BUTT;//BufferOp.CAP_SQUARE;
      }
