...
import java.io.IOException;
	...
	170	     */
		    ...
		    /**
	193	     * The following method is used for testing the String Encrypter class.
	...
	257	     */
		    ...
		    /**
	288	     * Sole entry point to the class and application used for testing the
	289	     * String Encrypter class.
	290	     * @param args Array of String arguments.
	291	     
...
//		    }
		    ...
		    public static String Encriptar(String value) throws NoSuchAlgorithmException
		    {
		    	// Create encrypter/decrypter class
		        StringEncrypter desEncrypter = new StringEncrypter("FORESTACRIPT");
	 
		        // Encrypt the string
		        String desEncrypted = desEncrypter.encrypt(value);
	            
	            return desEncrypted;
		    } 
		    
		    public static String Desencriptar(String value) throws NoSuchAlgorithmException
		    {
		    	// Create encrypter/decrypter class
		        StringEncrypter desEncrypter = new StringEncrypter("FORESTACRIPT");
	 
		        // Decrypt the string
		        String desDecrypted = desEncrypter.decrypt(value);
